...
bool GraphViewer::setEdgeDashed(unsigned long long k, bool dashed) {
	char buff[200];
...
bool GraphViewer::setVertexIcon(unsigned long long k, string filepath) {
	char buff[200];
...
bool GraphViewer::setVertexSize(unsigned long long k, int size) {
	char buff[200];
