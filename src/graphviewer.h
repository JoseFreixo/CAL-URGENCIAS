...
public:
	 ...
	 */
	bool setEdgeDashed(unsigned long long id, bool dashed);
	 ...
	 */
	bool setVertexSize(unsigned long long id, int size);
	 ...
	 */
	bool setVertexIcon(unsigned long long id, string filepath);
